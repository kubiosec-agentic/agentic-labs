...
![AutoGen](https://img.shields.io/badge/AutoGen-lightgrey)
![CrewAI](https://img.shields.io/badge/CrewAI-pink)
...
### CrewAI
This script uses CrewAI to coordinate two agents: a Senior Researcher and a Writer. Explore a topic (e.g., AI) and generate a blog post. The researcher gathers insights using a search tool. The writer creates a markdown-formatted article from the findings. Tasks are run sequentially with agent memory and caching enabled.
