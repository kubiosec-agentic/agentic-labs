"""
Exercise: Full RAG pipeline with OpenAI embeddings and GPT-4o.

Manually manages embeddings, queries ChromaDB with access-level
filtering, and uses GPT-4o to generate answers grounded in the
retrieved context.
